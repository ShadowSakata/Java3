...
public class MainFrame extends JFrame {
	...
	private void initMenu() {
		...
		Action searchRangeAction = new AbstractAction("Найти из диапазона") {
			public void actionPerformed(ActionEvent event) {
				String value = JOptionPane.showInputDialog(MainFrame.this, "Введите начало диапазона",
						"Поиск значения", JOptionPane.QUESTION_MESSAGE);
				renderer.setRangeStart(value);
				value = JOptionPane.showInputDialog(MainFrame.this, "Введите конец диапазона",
						"Поиск значения", JOptionPane.QUESTION_MESSAGE);
				renderer.setRangeEnd(value);
				getContentPane().repaint();
			}
		};
		...
		Action showHelpAction = new AbstractAction("О программе") {
			public void actionPerformed(ActionEvent ev) {
				ImageIcon icon = new ImageIcon("C:/Users/shift/eclipse-workspace/Java3/src/StudentPhoto.jpg");
				JOptionPane.showConfirmDialog(MainFrame.this, "Романчик 9 группа", 
						"wat", JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE, icon);
			}
		};
